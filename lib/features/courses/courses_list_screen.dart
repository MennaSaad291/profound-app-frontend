...
class _CoursesModuleScreenState extends State<CoursesModuleScreen> {
  ...
  // Mock data based on your React Course interface
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Text("My Courses", style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
            const Text("UCD-9", style: TextStyle(color: Colors.white70, fontSize: 12)),
          ],
        ),
        centerTitle: true,
      ),
